...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    // Bir JWT token'ını alır ve Spring Security'nin kimlik doğrulaması
    //ve yetkilendirme işlemlerinde kullanabileceği
    ...
    // Varsayılan olarak sub claim'ini kullanır,
    //ancak properties.getPrincipleAttribute() değerine göre
    // özelleştirilebilir. KeyCloakConfiguration sınıfı ile birlikte çalışır
    //ve bu sınıftan alınan konfigürasyon
    ...
    // Bu metot jwt token'ı içindeki resource_access claim'inden
    //kaynak sunucusuna özel rolleri ayıklamayı sağlar.
